...
#ifndef _Adafruit_SSD1306_Wemos_H_
#define _Adafruit_SSD1306_Wemos_H_
...
*/
class Adafruit_SSD1306_Wemos : public Adafruit_GFX {
public:
    // NEW CONSTRUCTORS -- recommended for new projects
    Adafruit_SSD1306_Wemos(uint8_t w, uint8_t h, bool is_wemos_oled = false, TwoWire *twi = &Wire,
                     int8_t rst_pin = -1, uint32_t clkDuring = 400000UL,
                     uint32_t clkAfter = 100000UL);
    Adafruit_SSD1306_Wemos(uint8_t w, uint8_t h, int8_t mosi_pin, int8_t sclk_pin,
                     int8_t dc_pin, int8_t rst_pin, int8_t cs_pin);
    Adafruit_SSD1306_Wemos(uint8_t w, uint8_t h, SPIClass *spi, int8_t dc_pin,
                     int8_t rst_pin, int8_t cs_pin, uint32_t bitrate = 8000000UL);

    // DEPRECATED CONSTRUCTORS - for back compatibility, avoid in new projects
    Adafruit_SSD1306_Wemos(int8_t mosi_pin, int8_t sclk_pin, int8_t dc_pin,
                     int8_t rst_pin, int8_t cs_pin);
    Adafruit_SSD1306_Wemos(int8_t dc_pin, int8_t rst_pin, int8_t cs_pin);
    Adafruit_SSD1306_Wemos(int8_t rst_pin = -1);

    ~Adafruit_SSD1306_Wemos(void);
...
protected:
    ...
    bool isWemosOled; ///< If this is specific WEMOS oled display.
...
#endif // _Adafruit_SSD1306_Wemos_H_
